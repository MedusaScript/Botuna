...
frame.BorderColor3 = Color3.fromRGB(255, 255, 255) -- Warnanya Gw Ubah Jadi Putih
frame.Active = true
...
validationLabel.Text = "Made By Famzz X Botuna"
...
checkKeyButton.MouseButton1Click:Connect(function()
    ...
    if verify(key) then
        ...
        validationLabel.TextColor3 = Color3.fromRGB(0, 255, 0)
        wait(2)
        validationLabel.Text = "Thanks For Use Script"
        validationLabel.TextColor3 = Color3.fromRGB(0, 255, 0)
        wait(2)
