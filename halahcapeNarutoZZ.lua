...
headerLabel.Text = "EXTERNAL HUB" -- ngaran
...
label.Text = "NEW UPDATE PLEASE GET NEW KEY"
...
local enteredKey = textBox.Text
    ...
    if enteredKey == currentKey then
        ...
        loadstring(game:HttpGet("https://raw.githubusercontent.com/FamzzOnTop/externalhub-m-1/main/ExternalHubV2.lua",true))()
else
