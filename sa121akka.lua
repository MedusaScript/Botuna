...
local LogoHub = Instance.new("ImageLabel")
    ...
    LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(18960986232) --logo didalam tab disini
...
local LogoToggle = Instance.new("ImageLabel")
    ...
    LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(18960986232) --logo toggle
...
local Library = Update:Window("            Blox Fruit","18960986232",Enum.KeyCode.RightControl); --12523036534
...
game.StarterGui:SetCore("SendNotification", {
      Icon = "http://www.roblox.com/asset/?id=18960986232";
      Title = "Brutality Hub", 
