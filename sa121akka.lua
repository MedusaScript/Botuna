...
local LogoHub = Instance.new("ImageLabel")
    ...
    LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(18959954963) --logo didalam tab disini
...
local Library = Update:Window("            Blox Fruit","18959954963",Enum.KeyCode.RightControl); --12523036534
