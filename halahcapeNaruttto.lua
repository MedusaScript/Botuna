...
headerLabel.Text = "BRUTALIY HUB V4" -- ngaran
...
validationLabel.Text = "Easy for get key"
...
local enteredKey = textBox.Text
    local currentKey = "key:ɐpuns ʞɐpnɹɐq ɓuıɐ" -- ganti ini dengan key yang benar
    if enteredKey == currentKey then
        ...
        loadstring(game:HttpGet("https://raw.githubusercontent.com/vldtncywdlojtnvjlmvyrbszljd/48139u372988729j82hd/main/%253%259%257%25_x%25t%25y%25_s%25l%25r%25u%25d%25a%25m-x9.lua",true))()
else
