...
if not isfolder("MaruSave") then
makefolder("MaruSave")
end
if not isfolder("MaruSave/Blox Fruits/") then
makefolder("MaruSave/Blox Fruits/")
end
if not isfile("MaruSave/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
writefile("MaruSave/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
else
...
LoadSettings()
  ...
  local Decode = game:GetService("HttpService"):JSONDecode(readfile("MaruSave/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
local Array = {}
for i,v in pairs(_G.Settings) do
Array[i] = v
end
writefile("MaruSave/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
end
else
  return warn("Status : Undetected Executor")
end
