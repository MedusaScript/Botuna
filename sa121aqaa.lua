...
local ToggleHumanandghoul = Tabs.Race:AddToggle("Auto Kill Players", {Title = "Auto [Auto Kill Players ] Trial", Default = false })
ToggleAuto Kill Playersl:OnChanged(function(Value)
    KillAura = Value
end)
Options.ToggleHumanandghoul:SetValue(false)
