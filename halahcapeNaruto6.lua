...
H:AddDropdown("Select Weapon",WeaponList,_G.SelectWeapon,function(value)
...
FarmMode = "Normal"
H:AddDropdown("Farm Mode", ListF,FarmMode,function(value)
    FarmMode = value
end)
...
if World1 then
    H:AddToggle("Auto Farm Fast",_G.AutoFarmFast,"Farm Sky Lv.10-75",function(value)
        _G.Farmfast = value
    ...
    H:AddToggle("Auto Farm Gun Mastery",_G.AutoFarmGunMastery,"Auto Kill Mob Using Gun",function(value)
