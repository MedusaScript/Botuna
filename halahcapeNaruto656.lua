...
local LogoHub = Instance.new("ImageLabel")
    ...
    function uitab:AddTab(text,image)
        ...
        function main:AddToggle(text,config,callback)
            ...
            Label.Name = "Label"
            Label.Parent = Toggle
            Label.BackgroundColor3 = Color3.fromRGB(12, 0, 0)
...
local SE = Library:AddTab("Sea Event","7044233235")
...
if World1 then
Main:AddToggle("Auto Farm Fast",_G.AutoFarmFast,function(value)
    _G.Farmfast = value
