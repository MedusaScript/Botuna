...
local Tab = Window:CreateTab("Home", 18796954010) -- Title, Image
local Tab1 = Window:CreateTab("The Best", 18477473610)
local Tab2 = Window:CreateTab("Mod Hack", 18796955892)
local Tab3 = Window:CreateTab("All Script", 18492098759)
