...
local Tabs = {
    ...
    Mt = Window:AddTab({ Title = "Quest Item", Icon = "lucide-puzzle" }),    
    De = Window:AddTab({ Title = "Fruit & Raid", Icon = "lucide-cherry" }),   
    Qs = Window:AddTab({ Title = "Quest Race V4", Icon = "arrow-up-down" }),        
    RC = Window:AddTab({ Title = "Trial V4", Icon = "lucide-bot" }),   
    ...
    St = Window:AddTab({ Title = "Status Server", Icon = "lucide-file-bar-chart-2" }),
...
spawn(function()
    ...
    local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Turn On Haki", Default = false })
