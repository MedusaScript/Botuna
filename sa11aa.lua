...
local Window = Rayfield:CreateWindow({
	Name = "Brutality Hub Universal",
	LoadingTitle = "Tysm using brutality hub",
	LoadingSubtitle = "by Medusa Script",
	ConfigurationSaving = {
		Enabled = true,
		FolderName = "Brutality Hub Universal",
		FileName = "Brutality Hub"
	},
...
Rayfield:Notify("Brutality Hub Universal", "Testing notif text", 18797339934) -- Notfication -- Title, Content, Image

local Tab = Window:CreateTab("Home", 18797343654) -- Title, Image
local Tab1 = Window:CreateTab("The Best", 18797339934)
local Tab2 = Window:CreateTab("Mod Hack", 18796955892)
local Tab3 = Window:CreateTab("All Script", 18797345795)

local Section = Tab1:CreateSection("The Best Script")

local Button = Tab1:CreateButton({
	Name = "Brutality Hub V1",
	Callback = function()
