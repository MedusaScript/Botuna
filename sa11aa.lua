local Init = function(data)
	loadstring(game:HttpGet('https://raw.githubusercontent.com/MedusaScript/y/main/BrutalityHubV3-New.lua'))()
...
local InternalTable = { -- change
    Service = "Brutality_Hub", -- Identifier Name *
...
local result = isfile("Pelinda Data/Infinix/Key.txt") and Validate(readfile("Pelinda Data/Infinix/Key.txt"))
