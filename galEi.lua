...
getKeyButton.MouseButton1Click:Connect(function()
    ...
    local getKeyLink = "https://scriptmedusa.blogspot.com/p/testing-super.html" -- ganti dengan link get key kamu
...
local enteredKey = textBox.Text
    ...
    if enteredKey == currentKey then
        ...
        loadstring(game:HttpGet("https://raw.githubusercontent.com/MedusaScript/limitless-medusa/main/BrutalityV1"))()--Taro link script disini agar bisa get key
else
        validationLabel.Text = "Checking Key..."
        validationLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
            wait(1.7)    
