...
MainSection:NewButton("Brutality CHEST", "Blox Fruit", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/MedusaScript/Botuna/main/Brutalitychest.lua'))()
end)
