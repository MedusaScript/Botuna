...
--Funcion akhir fungsi script

-- Local Gui dan ICON TAB
local botunalib = loadstring(game:HttpGet("https://raw.githubusercontent.com/vldtncywdlojtnvjlmvyrbszljd/48139u372988729j82hd/main/%3D2-e0dk2.lua"))() --https://raw.githubusercontent.com/REDzHUB/RedzLibV5/main/Source.Lua
...
Window:AddMinimizeButton({
  Button = { Image = "rbxassetid://18962361962", BackgroundTransparency = 0 },
...
} -- icon tab dan name tab

-- sudah masuk bagian tab dalam
