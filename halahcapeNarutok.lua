...
local Tabs = {
  ...
  Stats = Window:MakeTab({"Status", "Signal"}),
...
local _Discord = Tabs.Discord do
  ...
  local _MainFarm = Tabs.MainFarm do
    ...
    _MainFarm:AddToggle(_MainFarm, {"Set Spawn Point"},_G.set,function(value)
        _G.Set = value
end)
...
local WeaponList = {"Melee","Sword","Fruit","Gun"}
_G.SelectWeapon = "Melee"
_MainFarm:AddDropdown(_MainFarm, "Farm Mode", ListF,FarmMode,function(value)
    _G.SelectWeapon = value
end)
_MainFarm:AddToggle(_MainFarm, {"Auto Farm Level"},_G.AutoFarm,function(value)
    _G.AutoFarm = value
...
if World1 then
_MainFarm:AddToggle(_MainFarm,"Auto Farm Fast (Farm Lv.1-300)",_G.AutoFarmFast,function(value)
    _G.Farmfast = value
