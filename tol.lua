...
NguyenTien:AddLabel("╼〢 Owner : Medusa Script")
NguyenTien:AddLabel("╼〢 Support Code : BOTUNA ")
NguyenTien:AddLabel("╼〢 Design : Bocah Tua Nakal")
NguyenTien:AddLabel("╼〢 Language: English")
NguyenTien:AddLabel("╼〢 Note: Join discord for use webhook notify")

NguyenTien:AddSeperator("Join Community")
NguyenTien:AddButton("Website Script & Executor",function()
setclipboard("https://medusascript.xyz")
        ...
        while wait() do
            pcall(function()
                if string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88 then
                    MobKilled:Set("┄〢 Defeat Npc : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,41))
                elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87 then
                    MobKilled:Set("┄〢 Defeat Npc : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,40))
                elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
                    MobKilled:Set("┄〢Defeat Npc : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,39))
                else
                    MobKilled:Set("┄〢 Boss Is Spawning")
                end
            end)
        end
    end)
...
spawn(function()
    ...
    spawn(function()
        pcall(function()
            while wait() do
                EliteProgress:Set("┄〢 Elite Progress : "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress"))
            end
        end)
    end)
		...
		while wait() do
			pcall(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
					Elite_Hunter_Status:Set("{"┄〢 Elite Spawn!")	
				else
					Elite_Hunter_Status:Set("{"┄〢Elite Not Spawn")	
				end
			end)
		end
	end)
...
HyperCahaya(CFrame.new(-5419.98095703125, 1093.3375244140625, -2666.730712890625))
    ...
    spawn(function()
        while wait() do
            pcall(function()
                BoneCheck:Set("┄〢 Your Bone: "..(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Check")))
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                ObservationRange:Set("┄〢 Observation Level : "..math.floor(game:GetService("Players").LocalPlayer.VisionRadius.Value))
            end)
        end
    end)
...
Misc:AddButton("Kaitun Cap", function(value)
    ...
    Misc:AddToggle("Remove Damage Notify",function()
		for i,v in pairs(game.Workspace:GetDescendants()) do
...
Misc:AddSeperator("ESP MENU")
    ...
    Misc:AddToggle("ESP Fruit Spawn",RealFruitESP,function(a)
        RealFruitESP = a
...
Misc:AddToggle("Esp Mob", false, function(nec)
    ...
    Misc:AddToggle("No Clip & FLY",_G.NOCLIP,function(value)
        _G.NOCLIP = value
    end)
