...
gay = tick()
print("[Brutality Hub Notify] Connecting To Server");

print("[Brutality Hub Notify] Connected To Server"); 

print("[Brutality Hub Notify] Fetching Requirements Data..."); 

print("[Brutality Hub Notify] Saving Data To Workspace"); 

print("[Brutality Hub Notify] Authencating..."); 
wait(.2)
print("[Brutality Hub Notify] Authencation Disabled, Loading Script...");

print("[Brutality Hub Notify] Loaded In "..tostring(tick()-gay).."ms")
...
if _G.PMT_Key == "PMTKAITUN" then
    if _G.PMTKAITUN then
        print "Brutality Hub: Whitelist Success, Execute Kaitun..."
        require(game.ReplicatedStorage:WaitForChild("Notification")).new(
            " <Color=Blue> Brutality Hub Kaitun Beta Version ! <Color=/> "
        ):Display()
        ...
        W.Color =
            ...
            ColorSequenceKeypoint.new(0.17, Color3.fromRGB(240, 117, 17)),
            ColorSequenceKeypoint.new(0.22, Color3.fromRGB(242, 87, 15)),
            ColorSequenceKeypoint.new(0.28, Color3.fromRGB(240, 117, 17)),
            ColorSequenceKeypoint.new(0.33, Color3.fromRGB(242, 87, 15)),
            ColorSequenceKeypoint.new(0.39, Color3.fromRGB(240, 117, 17)),
            ColorSequenceKeypoint.new(0.45, Color3.fromRGB(242, 87, 15)),
            ColorSequenceKeypoint.new(0.50, Color3.fromRGB(240, 117, 17)),
            ColorSequenceKeypoint.new(0.56, Color3.fromRGB(242, 87, 15)),
            ColorSequenceKeypoint.new(0.61, Color3.fromRGB(240, 117, 17)),
            ColorSequenceKeypoint.new(0.67, Color3.fromRGB(242, 87, 15)),
            ColorSequenceKeypoint.new(0.72, Color3.fromRGB(240, 117, 17)),
            ColorSequenceKeypoint.new(0.78, Color3.fromRGB(242, 87, 15)),
            ColorSequenceKeypoint.new(0.84, Color3.fromRGB(240, 117, 17)),
            ColorSequenceKeypoint.new(0.89, Color3.fromRGB(242, 87, 15)),
            ColorSequenceKeypoint.new(0.95, Color3.fromRGB(240, 117, 17)),
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(242, 87, 15))
        }
        ...
        Y.Text = "Kaitun by MedusaScript"
        Y.TextColor3 = Color3.fromRGB(0, 242, 57)
        Y.TextSize = 16.000
