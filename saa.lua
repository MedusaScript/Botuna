...
local library = {
	WorkspaceName = "Made By Medusa Script",
	flags = {},
	signals = {},
	objects = {},
	elements = {},
	...
	colors = {
		...
		otherElementText = Color3.fromRGB(250, 250, 250),
		elementText = Color3.fromRGB(250, 250, 250),
...
local StartKaitun = Genaral:CreateSection({
    Name = "[ Start Kaitun ]",
    Side = "Right"
})
local Stutas = StartKaitun:AddLabel({
    Name = "Status : "
})
...
local StutasF = StartKaitun:AddLabel({
    Name = "Stutas Farm : Farm Level"
})

StartKaitun:AddToggle({
    Name = "Start Kaitun",
	Value = false,
                            ...
                            if v:IsA("Tool") then
                                if string.find(v.Name, "Fruit") then
                                    repeat
                                        ...
                                        wait(.1)
                                    until not _G.Start_Kaitun or v.Parent == game.Players.LocalPlayer.Character
                                end
                            end
                        end
                    end
