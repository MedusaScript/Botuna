...
local enteredKey = textBox.Text
    local currentKey = "I love Mommy" -- ganti ini dengan key yang benar
    if enteredKey == currentKey then
        ...
        loadstring(game:HttpGet("https://raw.githubusercontent.com/MedusaScript/limitless-medusa/main/BloxFruit_V3.lua"))()
else
        validationLabel.Text = "Checking Game..."
        validationLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
            wait(1.7)    
