...
local Main = Library:AddTab("Farm","18477352687")
local M = Library:AddTab("Quest","18477473641")
local Ss = Library:AddTab("Stats","18477368691")
local RaceV4 = Library:AddTab("Trial V4","18477358168")
local P = Library:AddTab("Bounty","18477350160")
local R = Library:AddTab("Auto Raid","18477546565")
local T = Library:AddTab("Teleport","18477347761")
local S = Library:AddTab("Shop","18477410524")
local D = Library:AddTab("Devil Fruit","18477363147")
local Misc = Library:AddTab("Setting","18477556171")
--- Nama toggle ui
...
Misc:AddToggle("Esp Mob", false, function(nec)
    ...
    Misc:AddToggle("NoClip & FLY",_G.NOCLIP,function(value)
        _G.NOCLIP = value
    end)
