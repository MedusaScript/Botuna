...
local ServiceIdentifier = "_brutalityhub_" or "(__YourServiceIdentifier__)"
local ServiceName = "Brutality_Hub" or "(__YourServiceName__)"
local APIToken = "MV4posdIwO1YRnJ1" or "(__YourAPIToken__)"
local KeyPrefix = "HWID-key:" or "(__YourKeyPrefix__)"
local KeyDirectory = "HWID-key:" or "(__YourKeyDirectory__)"
...
local InternalTable = { 
	...
	KickWebhook = nil;
	ValidWebhook = "https://discord.com/api/webhooks/1269384347979354134/bgJiCi1SUOqpMa2KuUnYHtWVHmCXUqzsvICP6haex9VTCkcM6AkDmLQHYK4AwdKeWLbF";
	InvalidWebhook = "https://discord.com/api/webhooks/1269384349841887343/J-XAFU2KWBR6snWhajErO0pvU-h1cQDwJfaXmwhNm-GWfAbQxc3OWZM3d5h-MhHj3jyh";
    Debug = false;
}
