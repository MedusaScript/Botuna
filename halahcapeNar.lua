...
H:AddLabel("[GameTime] : Hours : "..Hour.." Min : "..Minute.." Sec : "..Second)
end
...
FrozenIsland = M:AddLabel("")
   ...
   M:AddToggle("Auto Tp Kitsune Island",_G.AutoFKitsune,function(value)
...
spawn(function()
	...
	Ss:AddButton("Join Server Joib Id",function()
