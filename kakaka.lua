...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('BRUTALITY HUB Premium') then
        makefolder('BRUTALITY HUB Premium')
    end
    if not _G.Dis and not isfile('BRUTALITY HUB Premium/'..Name..'.json') then
        writefile('BRUTALITY HUB Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('BRUTALITY HUB Premium') and isfile('BRUTALITY HUB Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('BRUTALITY HUB Premium/'..Name..'.json'))
