...
local Description = "Thanks For Using, Please Subscribe"
    ...
    spawn(function()
        while wait() do
            if _G.SafeFarm then
                ...
                game.Players.LocalPlayer:Kick("Medusa Security : Detect ( Anti Cheat ), Please rejoin !")
            end
        end
    end)
end ---notif run
...
ImageButton.BackgroundColor3 = Color3.fromRGB(171, 170, 164)
