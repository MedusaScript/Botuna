            ...
            if KitsuneIslandESP then
                if v.Name ~= "NeonShrinePart" then
                    if not v:FindFirstChild('IslandESP') then
                        ...
                        v['KitsuneIslandESP'].TextLabel.Text = "Kitsune Island"
                    end
                end
            else
                if v:FindFirstChild('KitsuneIslandESP') then
                    v:FindFirstChild('KitsuneIslandESP'):Destroy()
                end
            end
        end)
    end
...
Ss:AddToggle("Esp Kitsune Island",false, function(value)
