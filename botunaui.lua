local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/MedusaScript/Botuna/main/UI-Universal.lua"))()
local Window = Library.CreateLib("BRUTALITY HUB X MEDUSA SCRIPT - ALL SCRIPT IN ONE", "Ocean")

--UTAMA
local Main = Window:NewTab("PREMIUM")
local MainSection = Main:NewSection("PRISON LIFE - BRUTALITY HUB")
