...
local Shivamloader = Instance.new("TextLabel")
...
Shivamloader.BorderColor3 = Color3.fromRGB(0, 0, 0)
Shivamloader.BorderSizePixel = 0
...
Shivamloader.TextTransparency = 1
...
local pop = ts:Create(Shivamloader, TweenInfo.new(1), {TextTransparency = 0})
pop:Play()
...
local trans = ts:Create(Shivamloader, TweenInfo.new(1.5), {TextTransparency = 1})
trans:Play()
...
local UICorner_3 = Instance.new("UICorner")
local Shivamname = Instance.new("TextLabel")
...
Shivamname.Name = "Shivamname"
Shivamname.Parent = Title
Shivamname.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Shivamname.BackgroundTransparency = 1.000
Shivamname.BorderColor3 = Color3.fromRGB(0, 0, 0)
Shivamname.BorderSizePixel = 0
