...
local PhantomForcesWindow = Library:NewWindow("Kairo BETA")
...
local MiscKillingCheats = PhantomForcesWindow:NewSection("Misc")
...
Credits:CreateButton("Made by JosiahScripts", function()
    print("TrilleD")
end)

Credits:CreateButton("Assisted by Triple", function()
    print("TrilleD")
end)

Credits:CreateButton("JosiahScripts Discord", function()
