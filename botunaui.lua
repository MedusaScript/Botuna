--share = titit lu bernanah wkwkw
wait(1.5)

game.StarterGui:SetCore("SendNotification", {

Title = "Made By Botuna"; -- teks notif atas --jangan lu ubah

Text = "Still in the testing phase"; -- teks notif bawah -- bebas lu ubah
...
Credits:CreateButton("YT: @MedusaScriptRoblox", function() --jangan lu ubah
    print("TrilleD")
end)

Credits:CreateButton("CODE: by BOTUNA", function() --jangan lu ubah
    print("TrilleD")
end)

Credits:CreateButton("MASUKIN TEXT BEBAS", function() --boleh lu ganti
    print("TrilleD")
end)
