...
Text = "Bocah Tua Nakal Nih Boss..."; -- teks notif bawah
...
local Section = Window:NewSection("Setting")

Section:CreateToggle("Efect Kill", function(value)
	loadstring(game:HttpGet("https://raw.githubusercontent.com/MedusaScript/BrutalityV2/main/musik.lua"))()
	print(value)
	end)
...
local Section = Window:NewSection("SettingPlayer")
