...
local AutoParry = PhantomForcesWindow:NewSection("Setting")

AutoParry:CreateToggle("Anti Lag", function()loadstring(game:HttpGet("https://pastebin.com/raw/1RfvPdwX"))()
end)
