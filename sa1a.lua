...
headerLabel.Text = "UPDATE include all script" -- ganti dengan nama script hub kamu
...
label.Text = "Please Get New Script"
...
validationLabel.Text = "The best script 2024"
...
getKeyButton.MouseButton1Click:Connect(function()
    ...
    local getKeyLink = "https://bit.ly/4fA1sUW" -- ganti dengan link get key kamu
    setclipboard(getKeyLink)
    validationLabel.Text = "Link update copied!"
...
local enteredKey = textBox.Text
    ...
    if enteredKey == currentKey then
        ...
        validationLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
            wait(1.7)
        validationLabel.Text = "Script Need Update!"
        validationLabel.TextColor3 = Color3.fromRGB(0, 255, 0)
        wait(2)
        validationLabel.Text = "Please get new script"
        validationLabel.TextColor3 = Color3.fromRGB(0, 255, 0)
        wait(2)
        ...
        validationLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
            wait(1.7)    
        validationLabel.Text = "Please Update Script"
        validationLabel.TextColor3 = Color3.fromRGB(255, 0, 0)
    end
end)
