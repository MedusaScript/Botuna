...
function Update:Window(text,logo,keybind)
    ...
    Ping.Text = "Brutality Hub | By Medusa Script          [SCRIPT PREMIUM]"
...
Main:AddToggle("Auto Click",function(value)
   ...
   Main:AddToggle("Blox Fruit Mastery",_G.AutoFarmFruitMastery,function(value)
...
Main:AddToggle("Farm Gun Mastery",_G.AutoFarmGunMastery,function(value)
